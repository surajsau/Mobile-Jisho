//package com.halfplatepoha.jisho.details;
//
...
//import com.halfplatepoha.jisho.apimodel.Link;
...
//    CustomTextView tvExtraJapanese;
//
//    @BindView(R.id.tvExtraHiragana)
//    CustomTextView tvExtraHiragana;
//
...
//
//        //--add kanjis
//        String[] kanjis = Utils.kanjiList(mPrimary.getWord());
...
//        if(isFaved) {
//            isFaved = false;
//            btnFav.setImageDrawable(ContextCompat.getDrawable(this, R.drawable.tab_list));
//        } else {
//            isFaved = true;
//            btnFav.setImageDrawable(ContextCompat.getDrawable(this, R.drawable.fav));
//        }
...
//    }
//
//    private void openDetails(String kanji) {
//
//    }
//
//    @OnClick(R.id.back)
