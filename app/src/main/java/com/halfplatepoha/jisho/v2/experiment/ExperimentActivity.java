...
////            final Realm realm = Realm.getInstance(JishoApp.getInstance().getRelineRealmConfiguration());
////
////            try {
...
//    public void run() {
//
////        OfflineDatabase offlineDatabase = DatabaseProvider.getInstance(this).getRoomDatabase();
//
////        Realm realm = Realm.getInstance(JishoApp.getInstance().getRelineRealmConfiguration());
////        SQLiteDatabase db = JishoApp.Companion.getDBInstance().getReadableDatabase();
//
